...
import { updatebook, uploadImage } from '../../actions/bookAction';
...
const EditBook = ({ location: { state: { current_book } } }) => {
    ...
    const [url, setUrl] = useState(`/uploads/${image}`);
    ...
    const onSubmit = e => {
        e.preventDefault();
        let data = formData;
        data.image = file && file.name ? file.name : image;
        data.id = current_book._id;
    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit={e => onSubmit(e)}>
                ...
                <div className="form-group">
                    <Select value={author} showSearch style={{ width: "100%" }} placeholder="Select a Author" optionFilterProp="children" onChange={onUserChange} filterOption={true}>
